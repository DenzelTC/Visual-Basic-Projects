Public Class frm_Register
    ...
    Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        If chkMathematics.Checked = True And chkGeography.Checked = True And chkScience.Checked = True Then
            MessageBox.Show("Welcome " & txtName.Text & " " & txtSurname.Text & "!" & vbNewLine & vbNewLine & "You will be doing Sciences")
        ElseIf chkAccounts.Checked = True And chkCommerce.Checked = True And chkMathematics.Checked = True Then
            MessageBox.Show("Welcome " & txtName.Text & " " & txtSurname.Text & "!" & vbNewLine & vbNewLine & "You will be doing Commercials")
        ElseIf chkEnglish.Checked = True And chkHistory.Checked = True And chkShona.Checked = True Then
            MessageBox.Show("Welcome " & txtName.Text & " " & txtSurname.Text & "!" & vbNewLine & vbNewLine & "You will be doing Arts")
        Else
